...
Route::group(['prefix' => 'V1' , 'as' => 'V1.'] , function (){
    ...
    Route::group(['prefix' => 'User' , 'as' => 'User.' ] , function (){
        ...
        Route::post('SearchAll' , [\App\Http\Controllers\Api\V1\UserController::class , 'SearchAll'])->name('SearchAll');
    });
    ...
    Route::group(['prefix' => 'Profile' , 'as' => 'Profile.' ] , function (){
        ...
        Route::post('UpdatePlatform' , [\App\Http\Controllers\Api\V1\UserController::class , 'UpdatePlatform'])->name('UpdatePlatform');
    ...
    Route::group(['prefix' => 'Payment' , 'as' => 'Payment.' ] , function (){
        ...
        Route::post('Swap' , [\App\Http\Controllers\Api\V1\PaymentsController::class , 'Swap'])->name('Swap');
    });
